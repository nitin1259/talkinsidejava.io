...
public class FindNearestAddress {
	...
	public static void main(String[] args) {
		...
		System.out.println( getNearestAddress(addList, "6279, Sector c6, Vasant Kunj"));
		System.out.println( getNearestAddress(addList, "Plot 18, National Hiway 8, udyog Vihar, Gurgaon"));
